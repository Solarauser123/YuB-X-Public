...
typedef struct global_State
{
    GCObject* gray; // 0x0
    GCObject* weak; // 0x8
    GCObject* grayagain; // 0x10
    lua_Alloc frealloc; // 0x18
    void* ud; // 0x20
    stringtable strt; // 0x28
    size_t GCthreshold; // 0x38
    size_t totalbytes; // 0x40
    ...
    int gcgoal; // 0x54
    UpVal uvhead; // 0x58
    struct lua_Page* freegcopages[LUA_SIZECLASSES]; // 0x80
    struct lua_Page* allgcopages; // 0x1C0
    struct lua_Page* sweepgcopage; // 0x1C8
    struct lua_Page* freepages[LUA_SIZECLASSES]; // 0x1D0
    struct lua_Page* allpages; // 0x310
    struct lua_State* mainthread; // 0x318
...
struct lua_State
{
    ...
    UpVal* openupval; // 0x58
    unsigned short nCcalls; // 0x60
    unsigned short baseCcalls; // 0x62
    int cachedslot; // 0x64
    LuaTable* gt; // 0x68
